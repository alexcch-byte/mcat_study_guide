    ...
    <div className="min-h-screen bg-neutral-950 text-neutral-100 px-6 py-10">
      <div className="max-w-2xl mx-auto">
        <div className="flex items-center justify-between mb-2">
          ...
          <Link href="/today" className="text-sm text-neutral-400 hover:text-white underline">
            ← Today
          </Link>
        </div>
        ...
        {loading ? (
          ...
          <>
            <div className="space-y-3 mb-8">
              {projections.map((p) => (
                <div key={p.section} className="p-4 rounded-lg border border-neutral-800 bg-neutral-900">
            ...
            <div className="p-4 rounded-lg border border-neutral-800 bg-neutral-900 text-center">
              <p className="text-xs text-neutral-500 mb-1">Estimated total</p>
              {allCalibrated ? (
                <p className="text-3xl font-mono">{total}</p>
              ) : (
                <p className="text-sm text-neutral-500">Not all sections have calibrated yet.</p>
              )}
            </div>
          </>
        )}
